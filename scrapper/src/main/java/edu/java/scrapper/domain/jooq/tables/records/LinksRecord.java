...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record6<Long, String, LocalDateTime, LocalDateTime, Integer, String> {
    ...
    @Override
    @NotNull
    public Row6<Long, String, LocalDateTime, LocalDateTime, Integer, String> valuesRow() {
    ...
    public Field<String> field6() {
        return Links.LINKS.ADDITIONAL_INFO;
    }
    ...
    @Override
    @NotNull
    public LinksRecord value6(@Nullable String value) {
    ...
    @Override
    @NotNull
    public LinksRecord values(@NotNull Long value1, @NotNull String value2, @NotNull LocalDateTime value3, @NotNull LocalDateTime value4, @NotNull Integer value5, @Nullable String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@NotNull Long linkId, @NotNull String url, @NotNull LocalDateTime lastUpdated, @NotNull LocalDateTime lastChecked, @NotNull Integer zoneOffset, @Nullable String additionalInfo) {
        super(Links.LINKS);
